...
<html>
  <head>
     <title>${message(code:'psrr.description')}</title>
  ...
  <body>
    <g:set var="requestTypeInfo">
      {"label": "${requestTypeLabel}"
        ,"steps": [  "requester-required",  "reservation-required",  "complement-required",  "validation-required"  ]
      }
    </g:set>
    ...
    <h2 class="request-creation"> <g:message code="psrr.label" /></h2>
    <p><g:message code="psrr.description" /></p> 
    <p><g:message code="request.duration.label" /><strong> : <g:message code="psrr.duration.value" /></strong></p>
    <p>
    ...
    <div id="requestTabView" class="yui-navset">
      <ul class="yui-nav">
        ...
        <li class="${['requester', 'firstStep'].contains(currentStep) ? 'selected' : ''}">
          ...
          <strong>
            <g:message code="psrr.step.requester.label" /> *
          </strong>
        ...
        <li class="${currentStep == 'reservation' ? 'selected' : ''}">
  
          <a href="#reservation"><em>
          <span class="tag-state ${stepStates!= null ? stepStates.reservation.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.reservation.i18nKey : 'request.step.state.uncomplete'}" /></span>
    
          <strong>
            <g:message code="psrr.step.reservation.label" /> *
          </strong>
        ...
        <li class="${currentStep == 'complement' ? 'selected' : ''}">
  
          <a href="#complement"><em>
          <span class="tag-state ${stepStates!= null ? stepStates.complement.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.complement.i18nKey : 'request.step.state.uncomplete'}" /></span>
    
          <strong>
            <g:message code="psrr.step.complement.label" /> *
          </strong>
     ...
     <div class="yui-content">
       ...
       <div id="requester">
         <form method="post"  id="stepForm-requester" action="<g:createLink action="step" />">
           ...
           <h3>
             ...
             <g:message code="psrr.step.requester.label" />
             <span><g:message code="psrr.step.requester.desc" /></span>
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/parkingSpaceReservationRequest/requester" />         
       ...
       <div id="reservation">
         <form method="post"  id="stepForm-reservation" action="<g:createLink action="step" />">
           <input type="hidden" name="returnUrl" value="${returnUrl}" />
           <h3>
             <span class="tag-state ${stepStates!= null ? stepStates.reservation.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.reservation.i18nKey : 'request.step.state.uncomplete'}" /></span>
             ...
             <g:message code="psrr.step.reservation.label" />
             <span><g:message code="psrr.step.reservation.desc" /></span>
             <span class="error">${stepStates?.reservation?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/parkingSpaceReservationRequest/reservation" />         
  
           </div>
           <div class="error" id="stepForm-reservation-error"> </div>
           <!-- Input submit-->
           <input type="hidden" name="requestTypeInfo" value="${requestTypeInfo}" />
           <input type="hidden" name="uuidString" value="${uuidString}" />
  
           <input type="submit" id="submit-step-reservation" name="submit-step-reservation" class="submit-step" value="${message(code:'action.validate')}" />
  
         </form>
         
         <g:if test="${helps.reservation != null}">       
         <div class="requestHelp">
           <h3><g:message code="header.help"/></h3>
           ${helps.reservation}
         </div>
       ...
       <div id="complement">
         <form method="post"  id="stepForm-complement" action="<g:createLink action="step" />">
           <input type="hidden" name="returnUrl" value="${returnUrl}" />
           <h3>
             <span class="tag-state ${stepStates!= null ? stepStates.complement.cssClass : 'tag-pending'}"><g:message code="${stepStates != null ? stepStates.complement.i18nKey : 'request.step.state.uncomplete'}" /></span>
             ...
             <g:message code="psrr.step.complement.label" />
             <span><g:message code="psrr.step.complement.desc" /></span>
             <span class="error">${stepStates?.complement?.errorMsg}</span>
           </h3>
           <p class="required-fields-notice"><g:message code="request.message.requiredFieldsNotice"/></p>
           <div>
  
            <g:render template="/frontofficeRequestType/parkingSpaceReservationRequest/complement" />         
  
           </div>
           <div class="error" id="stepForm-complement-error"> </div>
           <!-- Input submit-->
           <input type="hidden" name="requestTypeInfo" value="${requestTypeInfo}" />
           <input type="hidden" name="uuidString" value="${uuidString}" />
  
           <input type="submit" id="submit-step-complement" name="submit-step-complement" class="submit-step" value="${message(code:'action.validate')}" />
  
         </form>
         
         <g:if test="${helps.complement != null}">       
         <div class="requestHelp">
           <h3><g:message code="header.help"/></h3>
           ${helps.complement}
         </div>
       ...
       <div id="validation">
         <form method="post"  id="stepForm-validation" action="<g:createLink action="step" />">
           ...
           <div>
            ...
            <g:render template="/frontofficeRequestType/parkingSpaceReservationRequest/validation0" />
                 ...
                 <g:each var="missingStep" in="${missingSteps}">
                   <li>
                     <a id="active-tab-${missingStep}" href="#${missingStep}">
                       <g:message code="psrr.step.${missingStep}.label" />
                     </a>
                   </li>
                 </g:each>
               </ul>
