    ...
    <h3><g:message code="lcrr.step.enfant.label" /></h3>
      ...
      <dl>
        <dt><g:message code="lcrr.property.motifsDerogation.label" /></dt>
          <dd>
      ...
      <dl>
        <dt><g:message code="lcrr.property.modeAccueil.label" /></dt>
          <dd>
          <g:render template="/frontofficeRequestType/widget/localReferentialDataSummary" 
                    model="['javaName':'modeAccueil', 'lrEntries': lrTypes.modeAccueil.entries, 'depth':0]" />
          </dd>
