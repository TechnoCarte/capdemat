    ...
    <label class="required"><g:message code="lcrr.property.modeAccueil.label" /> *  <span><g:message code="lcrr.property.modeAccueil.help" /></span></label>
            <g:set var="modeAccueilIndex" value="${0}" scope="flash" />
            <g:render template="/frontofficeRequestType/widget/localReferentialData" 
                      model="['javaName':'modeAccueil', 'i18nPrefixCode':'lcrr.property.modeAccueil', 'htmlClass':'required  ', 
                              'lrEntries': lrTypes.modeAccueil.entries, 'depth':0]" />
