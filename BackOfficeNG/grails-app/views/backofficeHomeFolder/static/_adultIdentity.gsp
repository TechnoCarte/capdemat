...
<dd class="required">${g.capdematEnumToText(var:adult.title, i18nKeyPrefix:'homeFolder.adult.title')}</dd>
...
<dd class="required">${adult.lastName}</dd>
...
<dd class="required">${adult.firstName}</dd>
