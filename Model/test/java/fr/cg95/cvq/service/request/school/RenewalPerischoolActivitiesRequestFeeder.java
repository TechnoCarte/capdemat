 ...
 */
public class RenewalPerischoolActivitiesRequestFeeder {

    public static void feed(RenewalPerischoolActivitiesRequest request) {
    }

	public static void setSubject(RenewalPerischoolActivitiesRequest request,
