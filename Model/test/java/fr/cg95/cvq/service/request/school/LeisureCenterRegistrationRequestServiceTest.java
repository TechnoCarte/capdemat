 ...
 */
public class LeisureCenterRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="leisureCenterRegistrationRequestService")
    protected IRequestService requestService;

    protected LeisureCenterRegistrationRequest fillMeARequest() {
        LeisureCenterRegistrationRequest request = new LeisureCenterRegistrationRequest();
               ...
               request.setIdCentreLoisirs("IdCentreLoisirs");
            
          
        
          
          
               request.setEstTransport(Boolean.valueOf(true));
        ...
        LeisureCenterRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(LeisureCenterRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        LeisureCenterRegistrationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        LeisureCenterRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        LeisureCenterRegistrationRequest requestFromDb = (LeisureCenterRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        LeisureCenterRegistrationRequestFeeder
