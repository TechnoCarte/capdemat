 ...
 */
public class LeisureCenterRegistrationRequestFeeder {

    public static void feed(LeisureCenterRegistrationRequest request) {
    }

	public static void setSubject(LeisureCenterRegistrationRequest request,
