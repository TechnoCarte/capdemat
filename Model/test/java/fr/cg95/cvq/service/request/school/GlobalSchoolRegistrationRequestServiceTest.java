 ...
 */
public class GlobalSchoolRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="globalSchoolRegistrationRequestService")
    protected IRequestService requestService;

    protected GlobalSchoolRegistrationRequest fillMeARequest() {
        GlobalSchoolRegistrationRequest request = new GlobalSchoolRegistrationRequest();
              ...
              if ("InformationsComplementairesDerogation".length() > 1024)
                  request.setInformationsComplementairesDerogation("InformationsComplementairesDerogation".substring(0, 1024));
              else
                  request.setInformationsComplementairesDerogation("InformationsComplementairesDerogation");
        ...
        GlobalSchoolRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(GlobalSchoolRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        GlobalSchoolRegistrationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        GlobalSchoolRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        GlobalSchoolRegistrationRequest requestFromDb = (GlobalSchoolRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        GlobalSchoolRegistrationRequestFeeder
