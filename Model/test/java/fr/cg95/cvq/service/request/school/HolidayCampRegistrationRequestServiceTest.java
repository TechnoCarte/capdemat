 ...
 */
public class HolidayCampRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="holidayCampRegistrationRequestService")
    protected IRequestService requestService;

    protected HolidayCampRegistrationRequest fillMeARequest() {
        HolidayCampRegistrationRequest request = new HolidayCampRegistrationRequest();
        
          
          
            
               request.setLabelCentreSejours("LabelCentreSejours");
               ...
               request.setIdCentreSejours("IdCentreSejours");
        ...
        HolidayCampRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(HolidayCampRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        HolidayCampRegistrationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        HolidayCampRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        HolidayCampRegistrationRequest requestFromDb = (HolidayCampRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        HolidayCampRegistrationRequestFeeder
