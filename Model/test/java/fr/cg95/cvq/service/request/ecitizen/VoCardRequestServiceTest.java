...
import fr.cg95.cvq.business.request.ecitizen.*;
...
public class VoCardRequestServiceTest extends RequestTestCase {
    ...
    @Resource(name="voCardRequestService")
    protected IRequestService requestService;

    protected VoCardRequest fillMeARequest() {
        ...
        VoCardRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(VoCardRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        VoCardRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        VoCardRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        VoCardRequest requestFromDb = (VoCardRequest) requestSearchService.getById(requestId, true);
