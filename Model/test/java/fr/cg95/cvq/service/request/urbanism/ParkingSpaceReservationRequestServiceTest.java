 ...
 */
public class ParkingSpaceReservationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="parkingSpaceReservationRequestService")
    protected IRequestService requestService;

    protected ParkingSpaceReservationRequest fillMeARequest() {
        ParkingSpaceReservationRequest request = new ParkingSpaceReservationRequest();
               ...
               request.setVoiePietonne("VoiePietonne");
              ...
              request.setRequesterFirstAddressKind(AccountAddressKindType.CURRENT);
                ...
                request.setRequesterOtherAddress(BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012"));
                ...
                request.setRequesterFirstAddress(BusinessObjectsFactory.gimmeAdress("1", "Unit test address", "Paris", "75012"));
               ...
               request.setFurnitureLift(Boolean.valueOf(true));
          
        
          
          
            
              request.setRequesterOtherAddressKind(AccountAddressKindType.CURRENT);
        ...
        ParkingSpaceReservationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(ParkingSpaceReservationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        ParkingSpaceReservationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        ParkingSpaceReservationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request);
        ParkingSpaceReservationRequest requestFromDb = (ParkingSpaceReservationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        ParkingSpaceReservationRequestFeeder
