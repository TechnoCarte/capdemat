 ...
 */
public class HolidayCampRegistrationRequestFeeder {

    public static void feed(HolidayCampRegistrationRequest request) {
    }

	public static void setSubject(HolidayCampRegistrationRequest request,
