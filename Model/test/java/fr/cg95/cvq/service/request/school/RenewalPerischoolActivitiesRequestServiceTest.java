 ...
 */
public class RenewalPerischoolActivitiesRequestServiceTest extends RequestTestCase {
    
    @Resource(name="renewalPerischoolActivitiesRequestService")
    protected IRequestService requestService;

    protected RenewalPerischoolActivitiesRequest fillMeARequest() {
        RenewalPerischoolActivitiesRequest request = new RenewalPerischoolActivitiesRequest();
        ...
        RenewalPerischoolActivitiesRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(RenewalPerischoolActivitiesRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        RenewalPerischoolActivitiesRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        RenewalPerischoolActivitiesRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        RenewalPerischoolActivitiesRequest requestFromDb = (RenewalPerischoolActivitiesRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        RenewalPerischoolActivitiesRequestFeeder
