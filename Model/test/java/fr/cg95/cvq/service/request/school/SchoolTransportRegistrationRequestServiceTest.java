 ...
 */
public class SchoolTransportRegistrationRequestServiceTest extends RequestTestCase {
    
    @Resource(name="schoolTransportRegistrationRequestService")
    protected IRequestService requestService;

    protected SchoolTransportRegistrationRequest fillMeARequest() {
        SchoolTransportRegistrationRequest request = new SchoolTransportRegistrationRequest();
        
          
          
            
              if ("FrereOuSoeurNom".length() > 38)
                  request.setFrereOuSoeurNom("FrereOuSoeurNom".substring(0, 38));
              else
                  request.setFrereOuSoeurNom("FrereOuSoeurNom");
              ...
              if ("FrereOuSoeurPrenom".length() > 38)
                  request.setFrereOuSoeurPrenom("FrereOuSoeurPrenom".substring(0, 38));
              else
                  request.setFrereOuSoeurPrenom("FrereOuSoeurPrenom");
        ...
        SchoolTransportRegistrationRequestFeeder.feed(request);
        return request;
    }

    protected void completeValidateAndDelete(SchoolTransportRegistrationRequest request)
    ...
    public void testWithHomeFolderPojo()
        ...
        //////////////////////////////
        SchoolTransportRegistrationRequest request = fillMeARequest();
        request.setRequesterId(SecurityContext.getCurrentUserId());
        request.setHomeFolderId(homeFolderId);
        SchoolTransportRegistrationRequestFeeder.setSubject(request, requestService.getSubjectPolicy(), null, homeFolder);
        Long requestId = requestWorkflowService.create(request, null);
        SchoolTransportRegistrationRequest requestFromDb = (SchoolTransportRegistrationRequest) requestSearchService.getById(requestId, true);
    ...
    public void testWithoutHomeFolder()
        ...
        SchoolTransportRegistrationRequestFeeder
